...
function Main() {
  return (
    <div className="bg-[#181126] min-h-screen w-full">

      {/* HERO SECTION */}
      <div className="flex flex-col lg:flex-row w-11/12 mx-auto items-center">

        {/* LEFT SIDE */}
        <div className="w-full lg:w-3/4 flex flex-col gap-8 px-6 py-16 md:px-16 md:py-24 lg:px-40 lg:py-40">
        ...
        {/* RIGHT SIDE IMAGE */}
        <div className="w-full lg:w-1/4 flex justify-center pb-10 lg:pb-0">
          <img
            src={developer}
            alt="Developer"
      ...
      <div className="w-11/12 mx-auto">
        ...
        <h1 className="text-white font-extrabold text-3xl md:text-4xl lg:text-5xl px-4 md:px-10 lg:px-40 py-8 font-code">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
          ...
          <div className="w-full lg:w-2/3 px-4 lg:px-16 text-white text-lg md:text-xl leading-8 font-code">
            ...
            <ul className="flex flex-col gap-6">
              ...
              <li>
                ...
                <span className="text-[#C27AFF]">MongoDB</span>. I enjoy working
                across both frontend and backend development using the MERN
                stack.
              </li>
              ...
              <li>
                ...
                <span className="text-[#C27AFF]">Tailwind CSS</span>, and
                building full-stack applications with secure backend systems.
              </li>

              <li>
                Whenever possible, I love building projects, improving my
                problem-solving skills, and exploring tools like WordPress,
                Power BI, and Data Analytics to expand my technical knowledge.
              </li>
          ...
          <div className="w-full lg:w-1/3 flex justify-center">
            <img
              src={Shivam}
              alt="Shivam Image"
              className="w-52 rounded-3xl md:w-64 lg:w-72 transition-transform duration-500 hover:scale-130"
            />
          </div>
